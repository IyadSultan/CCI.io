...
*** PROVENANCE: this file is copied VERBATIM from the Session 11 ER-triage app
(triage/crypto.py). It is reproduced here unchanged so the synthetic-data kit runs
standalone, without a Session 11 checkout. The point of Lesson 8 is continuity —
the synthetic generator uses the EXACT same encode/encrypt functions your Session
11 app used. Do not edit this file; if Session 11's crypto changes, re-copy it. ***
