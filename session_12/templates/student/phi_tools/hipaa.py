...
PATTERNS = [
    ...
    # 15 — IP address
    # >>> TODO (Lesson 7, Task 1): add a pattern that detects an IP address.
    #     An IP looks like four numbers separated by dots, e.g. 142.250.65.78.
    #     HINT: r"\b(?:\d{1,3}\.){3}\d{1,3}\b"
    #     Uncomment the two lines below, paste the HINT as the pattern, then re-run
    #     the scanner. (The scanner still runs without this — you'll just miss IPs.)
    # (15, "IP address",
    #  re.compile(r"")),
